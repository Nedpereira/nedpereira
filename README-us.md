...
#### Profile in Portuguese: [<kbd><img title="Portuguese" alt="Portuguese" src="https://img.icons8.com/color/48/000000/brazil.png" width="22"></kbd>](https://github.com/Nedpereira/Nedpereira/blob/main/README.md)
...
<table width="100%">
  <tr>
    <td width="80%">
      <p>My name is Neder Pereira, I'm a full-stack developer focused on web applications, mobile, backend and project architecture.</p>
    </td>
